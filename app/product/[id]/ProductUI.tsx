...
import { ShoppingBag, Heart, Truck, ShieldCheck, Ruler, ArrowLeft, Minus, Plus, LayoutDashboard, AlertCircle } from 'lucide-react';
import { useCart } from '../../context/CartContext'; // Ajuste se necessário ../../context...
...
export default function ProductUI({ id }: { id: string }) {
  ...
  return (
    <div className="min-h-screen bg-white pt-24 pb-20 relative">
      <div className="max-w-7xl mx-auto px-6 mb-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-black transition-colors"><ArrowLeft size={18}/> Voltar</Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            <div className="space-y-4">
                <div className="aspect-[4/5] bg-gray-100 rounded-3xl overflow-hidden relative border border-gray-100 shadow-sm group">
                    <img src={activeImage} alt={product.name} className="w-full h-full object-cover transition-opacity duration-300"/>
